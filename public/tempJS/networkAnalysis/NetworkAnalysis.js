...
import {
    ...
    networkGeneration, storeResultofSparkFromController,getDeletedNodes,node_highlighting,selected_graph_query,getUserDetailsNA
} from './helper.js';
...
$("#centrality_exec").on('click', function (NAType, algo_option = $('#centrality_algo_choice').val()) {
    ...
    if(selected_graph_ids().length > 1){
        $("#messagebox").empty();
        $("#messagebox").append('<div class="card text-black m-2" style="background: #F7A394" id="infopanel"><i id="deleteinfoCard" class="fa fa-window-close text-neg" aria-hidden="true"></i><div class="d-flex justify-content-center text-black font-weight-bold card-body"> Please, Select a Single Network </div></div>');
        return;
    }else if(selected_graph_ids().length == 0){
        $("#messagebox").empty();
        $("#messagebox").append('<div class="card text-black m-2" style="background: #F7A394" id="infopanel"><i id="deleteinfoCard" class="fa fa-window-close text-neg" aria-hidden="true"></i><div class="d-flex justify-content-center text-black font-weight-bold card-body"> Please, Select a Network </div></div>');
        return;
    }
    ...
    centrality(url, data, currentNetworkEngine).then(response => {
        if (currentNetworkEngine == "networkx") {
            render_centrality_graph(data["input"], "networkDivid", data["algo_option"]).then(response => {
                ...
                draw_graph(response, "networkDivid");
                $("#messagebox").empty();
                $("#messagebox").append('<div class="card text-black m-2" style="background: #BFFAC0" id="infopanel"><i id="deleteinfoCard" class="fa fa-window-close text-neg" aria-hidden="true"></i><div class="d-flex justify-content-center text-black font-weight-bold card-body"> Centrality Successfully Calculated </div></div>');
            });
        } else if (currentNetworkEngine == "spark") {
...
$("#comm_exec").on('click', function (NAType = $("#NAEngine").val(), algo_option = "") {
    ...
    if (community_algo_option == "Async Fluidic") {
        ...
        if(!$("#noOfCommunities").val()){
            $("#messagebox").empty();
            $("#messagebox").append('<div class="card text-black m-2" style="background: #F7A394" id="infopanel"><i id="deleteinfoCard" class="fa fa-window-close text-neg" aria-hidden="true"></i><div class="d-flex justify-content-center text-black font-weight-bold card-body"> Please, enter number of communities </div></div>');
            return;        
        }
    ...
    community_detection(url, data, NAType).then(response => {
        if (currentNetworkEngine == "networkx") {
            ...
            $("#messagebox").empty();
            $("#messagebox").append('<div class="card text-black m-2" style="background: #BFFAC0" id="infopanel"><i id="deleteinfoCard" class="fa fa-window-close text-neg" aria-hidden="true"></i><div class="d-flex justify-content-center text-black font-weight-bold card-body"> Community Detection Performed Successfully </div></div>');
...
$("#union_exec").on('click', function () {
    if((selected_graph_ids().length == 0) || (selected_graph_ids().length == 1)){
        $("#messagebox").empty();
        $("#messagebox").append('<div class="card text-black m-2" style="background: #F7A394" id="infopanel"><i id="deleteinfoCard" class="fa fa-window-close text-neg" aria-hidden="true"></i><div class="d-flex justify-content-center text-black font-weight-bold card-body"> Please, select at least 2 Networks </div></div>');
        return;
    }
...
$("#intersection_exec").on('click', function (NAType = "networkx") {
    ...
    intersection(url, data, NAType).then(response => {
        if (NAType == "networkx") {
            ...
            $("#messagebox").empty();
            $("#messagebox").append('<div class="card text-black m-2" style="background: #BFFAC0" id="infopanel"><i id="deleteinfoCard" class="fa fa-window-close text-neg" aria-hidden="true"></i><div class="d-flex justify-content-center text-black font-weight-bold card-body"> Intersection Operation Performed Successfully </div></div>');
            return;
        } else if (currentNetworkEngine == "spark") {
...
$("#difference_exec").on('click', function (NAType = "networkx") {
    ...
    difference(url, data, currentNetworkEngine).then(response => {
        if (currentNetworkEngine == "networkx") {
            ...
            $("#messagebox").empty();
            $("#messagebox").append('<div class="card text-black m-2" style="background: #BFFAC0" id="infopanel"><i id="deleteinfoCard" class="fa fa-window-close text-neg" aria-hidden="true"></i><div class="d-flex justify-content-center text-black font-weight-bold card-body"> Difference Operation Performed Successfully </div></div>');
            return;
        } else if (currentNetworkEngine == "spark") {
