    ...
    <form id="taQueryInputs">
        ...
        <div id="haDateInput">
            <div class="form-group  dateinputForm my-0  mr-2  border smat-rounded d-flex px-2 py-1  bg-white">
                ...
                <input type="text" class="form-control datepicker-here " id="fromDateTA" placeholder="From Date"  style="border:0px;" autocomplete="OFF" data-language='en' required>
            </div>
            <div class="form-group dateinputForm my-0  mr-2 border smat-rounded d-flex px-2 py-1  bg-white">
                <i class="far fa-calendar-alt mx-2 text-normal" style="margin-top:11px;"></i>
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="card shadow mt-1">
                <div class="card-body">
                    <div>
                        <p class="m-0  smat-box-title-large">Top Hashtags <span class="mx-1  clickable text-dark "></span> </p>
                    </div>
